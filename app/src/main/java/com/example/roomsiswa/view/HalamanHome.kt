...
import androidx.compose.ui.input.nestedscroll.nestedScroll // <-- Tambahkan import ini
...
fun HomeScreen(
    ...
    Scaffold(
        ...
        topBar = {
            SiswaTopAppBar( // <-- Pastikan fungsi ini tersedia
...
// Tambahkan kode ini di file yang sama atau impor jika ada di file lain
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun SiswaTopAppBar(
    title: String,
